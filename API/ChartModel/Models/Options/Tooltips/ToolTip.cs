...
namespace API.Models
{
    ...
    public class ToolTip : Base
    {
        ...
        /// <summary>
        /// The mode for positioning the tooltip. 'average' mode will place the tooltip at the average position of the items displayed in the tooltip. 'nearest' will place the tooltip at the position of the element closest to the event position. New modes can be defined by adding functions to the WebBargTask.Tooltip.positioners map.
        /// </summary>
        public string Position { get; set; }

        /// <summary>
        /// Allows sorting of tooltip items. Must implement at minimum a function that can be passed to Array.prototype.sort. This function can also accept a third parameter that is the data object passed to the WebBargTask.
        /// </summary>
        [JsonConverter(typeof(PlainJsonStringConverter))]
        public string ItemSort { get; set; }

        /// <summary>
        /// Allows filtering of tooltip items. Must implement at minimum a function that can be passed to Array.prototype.filter. This function can also accept a second parameter that is the data object passed to the WebBargTask.
        /// </summary>
        [JsonConverter(typeof(PlainJsonStringConverter))]
