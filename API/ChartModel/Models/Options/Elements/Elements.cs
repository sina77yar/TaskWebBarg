namespace API.Models
{
    ...
    public class Elements : Base
    {
        ...
        /// <summary>
        /// Line elements are used to represent the line in a line WebBargTask.
        /// </summary>
        public Line Line { get; set; }

        /// <summary>
        /// Point elements are used to represent the points in a line chart or a bubble WebBargTask.
        /// </summary>
        public Point Point { get; set; }

        /// <summary>
        /// Rectangle elements are used to represent the bars in a bar WebBargTask.
        /// </summary>
